...
export default function DeleteAssignAc() {
  ...
  const deleteAcToSlot = async (event) => {
    event.preventDefault()
    event.stopPropagation()
    await axios({
      url:
      `${backendLink}/courseInstructor/deleteAssignmentAcademicMemberToSlots`,
      method: 'delete',
      ...
      <div>
        ...
        <Card className='ciCard' style={{ height: '33vw' }}>
          <Card.Body>
            ...
            >
              Delete assigned Academic Member
            </Card.Text>
            <table>
              <tbody>
                <tr>
            ...
            <Button
              ...
              onClick={(event) => deleteAcToSlot(event)}
            ...
            message ===
              ...
              'this exactly slot is not signed to this AcademicMember' ? (
              <Form.Text
                className='messagesStyling'
                style={{ marginLeft: '22vw' }}
              >
                staff does not have this slot!
              </Form.Text>
