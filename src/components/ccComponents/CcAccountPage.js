...
export default function CcAccountPage() {
    ...
    const viewProfileClick = () => {
      history.push('/ccViewProfile')
    }
    const updateProfileClick = () => {
      history.push('/updateProfileCc')
    }
    const resetPasswordClick = () => {
      history.push('/resetPasswordCc')
    }
            ...
            <tbody>
              <tr>
                ...
                <td className='staffColumnsStyling'>
                  ...
                  ></img>
                  <div className='staffFontsStyling' onClick={viewProfileClick} style={{color:'#999999'}}>
                    View Profile
                  </div>
                </td>
                <td className='staffColumnsStyling'>
                  ...
                  ></img>
                  <div className='staffFontsStyling' onClick={updateProfileClick} style={{color:'#999999'}}>
                    Update Profile
                  </div>
                </td>
                <td className='staffColumnsStyling'>
                  ...
                  ></img>
                  <div className='staffFontsStyling' onClick={resetPasswordClick} style={{color:'#999999' ,marginLeft:'-6vw'}}>
                    Reset Password
                  </div>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td className='staffColumnsStyling' style={{ paddingTop: '3vw' }}>
                  ...
                  <div
                    className='staffFontsStyling'
                    onClick={viewScheduleClick}
                    style={{color:'#999999',marginLeft:'-4vw'}}
                  >
                    View Schedule
                  </div>
                </td>
