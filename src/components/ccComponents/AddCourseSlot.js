...
export default function AddCourseSlot() {
  ...
  const addCourseSlot = async (event) => {
    event.preventDefault()
    event.stopPropagation()
    await axios({
      url: `${backendLink}/courseCoordinator/addCourseSlot`,
      method: 'post',
      ...
      if (error) {
        ...
        setMessage('course slot added successfully!')
        ...
        <Card className='ccCard' style={{ height: '41vw' }}>
          <Card.Body>
            ...
            <Button
              ...
              onClick={(event) => addCourseSlot(event)}
            ...
            {message === 'course slot added successfully!' ? (
              <Form.Text
            ...
            ) : message === '"typeOfSlot" is required' ||
            message ===
